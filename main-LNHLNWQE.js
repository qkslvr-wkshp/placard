import { a as b, b as x, c as y, d as w, e as S, f } from "./chunk-G7XEJ2LY.js";
import {
  Ia as M,
  Ja as P,
  K as u,
...
var v = [
    ...
    },
    {
      path: "about",
      loadChildren: () =>
        import("./chunk-IENDMKVD.js").then((e) => e.AboutModule),
    },
    {
    ...
    },
    {
      path: "products",
      loadChildren: () =>
        import("./chunk-A47NQ3LP.js").then((e) => e.ProductsModule),
    },
    { path: "**", component: p },
  ],
  I = class e {
    ...
    static ɵmod = C({ type: e });
    static ɵinj = u({ imports: [f.forChild(v), f] });
  };
var E = { providers: [k({ eventCoalescing: !0 }), S(v)] };
var z = (e, i) => i.title;
function R(e, i) {
